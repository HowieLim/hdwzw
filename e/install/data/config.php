...
//数据库设置
$ecms_config['db']['usedb']='<!--dbtype.phome.com-->';	//数据库类型
$ecms_config['db']['dbver']='<!--dbver.phome.com-->';	//数据库版本
$ecms_config['db']['dbserver']='<!--host.phome.com-->';	//数据库登录地址
$ecms_config['db']['dbport']='<!--port.phome.com-->';	//端口，不填为按默认
$ecms_config['db']['dbusername']='<!--username.phome.com-->';	//数据库用户名
$ecms_config['db']['dbpassword']='<!--password.phome.com-->';	//数据库密码
$ecms_config['db']['dbname']='<!--name.phome.com-->';	//数据库名
$ecms_config['db']['setchar']='<!--char.phome.com-->';	//设置默认编码
$ecms_config['db']['dbchar']='<!--dbchar.phome.com-->';	//数据库默认编码
$ecms_config['db']['dbtbpre']='<!--tbpre.phome.com-->';	//数据表前缀
$dbtbpre=$ecms_config['db']['dbtbpre'];	//数据表前缀
$ecms_config['db']['showerror']=1;	//显示SQL错误提示(0为不显示,1为显示)


//页面编码设置
$ecms_config['sets']['pagechar']='<!--headerchar.phome.com-->';	//安装帝国CMS的编码版本
...
//后台安全设置
$ecms_config['esafe']['loginauth']='<!--loginauth.phome.com-->';	//登录认证码,如果设置登录需要输入此认证码才能通过
$ecms_config['esafe']['ecookiernd']='<!--cookiernd.phome.com-->';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='<!--cookiepre.phome.com-->';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='<!--admincookiepre.phome.com-->';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='<!--qcookiernd.phome.com-->';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='<!--qcookierndtwo.phome.com-->';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
