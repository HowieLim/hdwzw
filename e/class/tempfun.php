...
function LoadTempInClass($path,$start,$userid,$username){
	...
	echo $fun_r['LoadOcomempSuccess']."(ID:<font color=red><b>".$newstart."</b></font>)<script>self.location.href='ecmstemp.php?enews=LoadTempInClass&start=$newstart".hReturnEcmsHashStrHref(0)."';</script>";
	exit();
}
