...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>类别</td><td bgcolor='ffffff'><input name="leibie" type="text" id="leibie" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[leibie]))?>" size="60">
