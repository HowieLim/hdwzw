...
function numberFormat(number, decimals, decPoint, thousandsSep) {
	var lang = defaultOptions.lang,
		// http://kevin.vanzonneveld.com/techblog/article/javascript_equivalent_for_phps_number_format/
		n = +number || 0,
		c = decimals === -1 ?
...
/**
 * Based on http://www.php.com/manual/en/function.strftime.php
 * @param {String} format
...
SVGRenderer.prototype = {
	...
	fontMetrics: function (fontSize) {
		...
		// Applies to the default font family. http://jsfiddle.com/highcharts/7xvn7/
...
/* ****************************************************************************
 *                                                                            *
 * START OF INTERcom EXPLORER <= 8 SPECIFIC CODE                              *
 *                                                                            *
...
/* ****************************************************************************
 *                                                                            *
 * END OF INTERcom EXPLORER <= 8 SPECIFIC CODE                                *
 *                                                                            *
 *****************************************************************************/
/* ****************************************************************************
 *                                                                            *
...
Axis.prototype = {
	...
	getLinePath: function (lineWidth) {
		var chart = this.chart,
			...
			licomop = chart.chartHeight - this.bottom - (opposite ? this.height : 0) + offset;
