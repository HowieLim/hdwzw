...
E_D("DROP TABLE IF EXISTS `www_92game_net_hdwan_enewspostserver`;");
E_C("CREATE TABLE `www_92game_net_hdwan_enewspostserver` (
...
E_D("replace into `www_92game_net_hdwan_enewspostserver` values('1','¸½¼þ·þÎñÆ÷','','1','','','','','','0','0','0','0','0');");
