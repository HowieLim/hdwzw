...
E_D("DROP TABLE IF EXISTS `www_92game_net_hdwan_enewsmoreport`;");
E_C("CREATE TABLE `www_92game_net_hdwan_enewsmoreport` (
...
E_D("replace into `www_92game_net_hdwan_enewsmoreport` values('1','ึ๗ทรฮสถห','','','','','0','0','0','0','');");
