...
E_D("DROP TABLE IF EXISTS `www_92game_net_hdwan_enewssearch`;");
E_C("CREATE TABLE `www_92game_net_hdwan_enewssearch` (
...
E_D("replace into `www_92game_net_hdwan_enewssearch` values('1','ÎóÉ±','1452581421','title','1','223.75.13.196','','1','newstime','0','b62baf5af0452e91ea8ad356867ed848','news','1','0',' and ((title LIKE ''%ÎóÉ±%''))','0');");
