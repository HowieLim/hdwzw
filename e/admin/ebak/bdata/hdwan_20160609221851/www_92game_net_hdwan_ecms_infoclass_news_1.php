...
E_D("DROP TABLE IF EXISTS `www_92game_net_hdwan_ecms_infoclass_news`;");
E_C("CREATE TABLE `www_92game_net_hdwan_ecms_infoclass_news` (
  ...
  `zz_leibie` text NOT NULL,
  `z_leibie` varchar(255) NOT NULL,
  `qz_leibie` varchar(255) NOT NULL,
  `save_leibie` varchar(10) NOT NULL,
  PRIMARY KEY (`classid`)
