...
function writeIm(textS, siteNm, topOffset) {
    ...
    rowStr += "</table><div class='ImFooter' onclick='__oran_kf_setKf(0,true)' style='cursor:pointer' title='隐藏客服菜单'><h5>鸿硕咨询热线</h5><p>" + Line + "</p></div></div></div>";
